									...
									<div class="user-data full-width">
										<div class="user-profile">
											<div class="username-dt">
												<div class="usr-pic">
                                                <img src="{{ url('images/profil', Auth::guard('jobeur')->user()->profil_img ) }}" alt="">
												</div>
											</div><!--username-dt end-->
											<div class="user-specs">
												<h3>{{ Auth::guard('jobeur')->user()->name }}</h3>
												<span>{{ Auth::guard('jobeur')->user()->note }}</span>
											</div>
											...
											<div class="post-bar no-margin">
												...
												<div class="job-status-bar">
                                                    ...
                                                    <li  ><a href="#" style="margin-top: 20px;" title="" class="com"><img src="/frontend/images/com.png" alt=""> Proposition(s) {{$post->propositions->count() }}</a></li>
														<li>
															<button type="button" style="margin-left: 350px;margin-top: -45px"  class="exp-bx-open btn btn-primary ">Add Proposition</button>

															<div class="overview-box" id="experience-box">
																<div class="overview-edit">
																	<h3>Proposition</h3>
                                                                    <form method="post" action="{{ route('jobeur.proposition.store') }}">
                                                                        @csrf

                                                                        <input type="hidden" name="id_post" value="{{ $post->id }}">
                                                                        <input type="hidden" name="id_jobeur" value="{{ Auth::guard('jobeur')->user()->id }}">

																		<div class="col-lg-12">
																			<input type="text" name="price" placeholder="Price">
																		</div>
																		<div class="col-lg-12">
																			<textarea name="proposition" placeholder="Proposition"></textarea>
																		</div>
