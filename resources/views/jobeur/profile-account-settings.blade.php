...
<head>
<meta charset="UTF-8">
<title>jobeur Account Setting</title>
				...
				<div class="header-data">
					...
					<nav>
						<ul>
							<li>
                                ...
                                @if (Auth::guard('jobeur')->check())
                                    <a href="{{ route('jobeur.home') }}" title="">
					...
					<div class="user-account">
						...
						<div class="user-account-settingss">
                            ...
                            <h3 class="tc">
                                <a href="{{ route('jobeur.logout') }}" class="dropdown-item btn btn-default btn-flat"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                <i class="fa fa-lock"></i>Logout
                                </a>
                                <form id="logout-form" action="{{ route('jobeur.logout') }}" method="POST" style="display: none;">
                                    @csrf
                                </form>
                            </h3>
							...
							<div class="tab-content" id="nav-tabContent">
							  	...
							  	<div class="tab-pane fade show active" id="nav-edit" role="tabpanel" aria-labelledby="nav-edit-tab">
									<div class="acc-setting">
                                        ...
                                        <form action="{{ route('jobeur.edit.profile') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="cp-field">
												<h5>Name</h5>
												<div class="cpp-fiel">
                                                    <input type="text" name="name" placeholder="Name" value="{{ Auth::guard('jobeur')->user()->name }}">
											...
											<div class="cp-field">
												<h5>Email</h5>
												<div class="cpp-fiel">
                                                    <input type="text" name="email" placeholder="Email" value="{{ Auth::guard('jobeur')->user()->email }}">
													<i class="fa fa-lock"></i>
												</div>
                                            </div>
											...
											<div class="cp-field">
												<h5>Phone</h5>
												<div class="cpp-fiel">
                                                    <input type="text" name="tel" placeholder="Phone" value="{{ Auth::guard('jobeur')->user()->tel }}">
													<i class="fa fa-lock"></i>
												</div>
                                            </div>
							  	...
							  	<div class="tab-pane fade" id="nav-deactivate" role="tabpanel" aria-labelledby="nav-deactivate-tab">
							  		<div class="acc-setting">
                                        ...
                                        <form action="{{ route('jobeur.deactivate.account_setting') }}"method="post">
