         ...
         <header style="height: 55px;">
            <div class="container">
               <div class="header-data">
                  <div class="logo">
                     <a href="home.html" title=""><img src="/frontend/images/logo.png" alt=""></a>
                  </div>
                  <!--logo end-->
      ...
      <div class="hero-image">
         <div class="container">
            <div class="hero-text">
               ...
               <button type="button" class="btn btn-primary btn-lg">Register As Jobeur</button>
               <button type="button" class="btn btn-primary btn-lg">Register As Client</button>
            </div>
         </div>
      </div>
